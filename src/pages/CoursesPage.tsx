  ...
  return (
    <div className="px-4 py-6">
      ...
      >
        ...
        <p className="text-neutral-400 text-sm">Explore guided sessions for your journey</p>
      </motion.div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  {course.isPremium && (
                    <Lock className="w-4 h-4 text-accent-400 flex-shrink-0" />
                  )}
                </div>
                <p className="text-sm text-neutral-400 mb-2">{course.subtitle}</p>
              ...
              <button className="w-10 h-10 rounded-full bg-accent-500/20 flex items-center justify-center flex-shrink-0 hover:bg-accent-500/30 transition-colors">

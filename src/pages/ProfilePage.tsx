    ...
    <div className="px-4 py-6 max-w-2xl mx-auto">
      ...
      >
        <div className="flex items-center gap-4 mb-6">
          <div className="w-16 h-16 rounded-full bg-gradient-to-br from-teal-500 to-purple-500 flex items-center justify-center">
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <div className="bg-neutral-100 dark:bg-neutral-900/50 rounded-xl p-3 text-center">
            <div className="flex justify-center mb-2">
              <Sparkles className="w-6 h-6 text-gold-500 dark:text-gold-400" />
            </div>
      ...
      >
        <div className="flex items-center justify-between mb-4">
          ...
          <button
            ...
            className="flex items-center gap-1 text-xs text-teal-600 dark:text-teal-400 bg-teal-100 dark:bg-teal-500/20 px-2 py-1 rounded-full hover:bg-teal-200 dark:hover:bg-teal-500/30 transition-colors"
          >
        ...
        {showAddGoal && (
          <div className="mb-4 p-3 bg-neutral-50 dark:bg-neutral-900/50 rounded-xl">
            <input
              ...
              className="w-full px-3 py-2 bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-lg text-neutral-900 dark:text-white placeholder-neutral-400 text-sm focus:outline-none focus:ring-2 focus:ring-teal-500"
            ...
            <div className="flex gap-2 mt-2">
              <button
                ...
                className="flex-1 py-2 bg-teal-500 hover:bg-teal-600 text-white text-sm font-medium rounded-lg transition-colors"
              >
                Add Goal
              </button>
              <button
                onClick={() => { setShowAddGoal(false); setNewGoalText(''); }}
                className="px-4 py-2 bg-neutral-200 dark:bg-neutral-700 text-neutral-700 dark:text-neutral-300 text-sm font-medium rounded-lg transition-colors hover:bg-neutral-300 dark:hover:bg-neutral-600"
              >
                Cancel
              </button>
            </div>
      ...
      <motion.div
        ...
        className="bg-gradient-to-br from-teal-500/10 to-purple-500/10 rounded-2xl p-6 border border-teal-500/20 mb-6"
      >
        <div className="flex items-center gap-3 mb-3">
          <Trophy className="w-6 h-6 text-teal-500 dark:text-teal-400" />
          <h3 className="font-semibold text-neutral-900 dark:text-white">Your Achievements</h3>
        </div>
        <div className="flex gap-3">
          <div className="w-12 h-12 rounded-xl bg-teal-500/20 flex items-center justify-center text-2xl" title="First Sign Found">
            🌟
          </div>
          <div className="w-12 h-12 rounded-xl bg-purple-500/20 flex items-center justify-center text-2xl" title="7-Day Streak">
            🔥
          </div>
          <div className="w-12 h-12 rounded-xl bg-green-500/20 flex items-center justify-center text-2xl" title="Goal Achiever">
            🎯
          </div>
          <div className="w-12 h-12 rounded-xl bg-neutral-200 dark:bg-neutral-700/50 flex items-center justify-center text-neutral-500 text-sm font-medium">
            +5
          </div>
        </div>
      </motion.div>

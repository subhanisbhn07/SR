  ...
  return (
    <>
      <motion.footer
        ...
        className="bg-surface-footer dark:bg-surface-footer-dark border-t border-neutral-200 dark:border-neutral-800 mt-12"
      >
            ...
            <div className="col-span-2 md:col-span-1">
              ...
              <div className="flex gap-3">
                <a
                  ...
                  className="w-9 h-9 rounded-lg bg-neutral-200 dark:bg-neutral-800 hover:bg-gradient-to-br hover:from-purple-500 hover:to-pink-500 hover:text-white flex items-center justify-center transition-all group"
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-9 h-9 rounded-lg bg-neutral-200 dark:bg-neutral-800 hover:bg-blue-400 hover:text-white flex items-center justify-center transition-all group"
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-9 h-9 rounded-lg bg-neutral-200 dark:bg-neutral-800 hover:bg-blue-600 hover:text-white flex items-center justify-center transition-all group"
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-9 h-9 rounded-lg bg-neutral-200 dark:bg-neutral-800 hover:bg-red-500 hover:text-white flex items-center justify-center transition-all group"

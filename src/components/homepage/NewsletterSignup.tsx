      ...
      <div className="p-8 rounded-2xl bg-gradient-to-br from-accent-500/10 to-purple-500/10 backdrop-blur-sm border border-accent-500/20 text-center relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-center justify-center mb-4">
            <Sparkles className="w-8 h-8 text-accent-400 mr-2" />
            <h2 className="text-2xl font-bold text-neutral-100">Subscribe to The Inner Signal</h2>
          </div>
          ...
          {!isSubscribed ? (
              ...
              <div className="flex space-x-3">
                <div className="flex-1 relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 bg-neutral-800/50 border border-neutral-600/50 rounded-xl text-neutral-100 placeholder-neutral-400 focus:outline-none focus:ring-2 focus:ring-accent-500 focus:border-transparent transition-all duration-200"
                    required
                  />
                </div>
            ...
            >
              ...
              <p className="text-accent-400 font-medium">Thank you for subscribing!</p>
              <p className="text-neutral-300 text-sm">Check your inbox for a welcome message.</p>
            </motion.div>
          )}
